...
of this program. The handwritten character are assumed to be in an upright
position when input into the system.
...
recognizing. This also makes comparing the accuracy of OCRacle to the OAR project
