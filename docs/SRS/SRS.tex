...
understanding of the command line to setup the program. The provided
...
constrain the scope of the project, A\ref{A_LatinUppercase} restricts which
...
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
  ...
  A\ref{A_LatinUppercase} &       &      &         &         &         &       &        & X           &                  \\ \hline
