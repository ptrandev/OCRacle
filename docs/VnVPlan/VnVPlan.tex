...
For the extra task, I will be including a video code walkthrough. This will
explain how the code works to achieve the desired functionality and give
technical users an understanding of how to train, evaluate, and test the model.
