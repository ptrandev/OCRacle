...
can correctly predict characters from images.
...
in the alphabet, and the sum of the probabilities should be 1.
...
Input/Condition: A set of test images from the EMNIST dataset that differ from
the training set.
					
Output/Result: The system outputs a confusion matrix and overall accuracy
percentage. Report the relative error compared to previous benchmarks.
...
difficulties encountered. The survey will be included in the Appendix.
