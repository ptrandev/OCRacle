...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
predict & imageMatrix: $\mathbb{Z}^{w \times w}_{0 \le x \le 255}$ & confidenceMatrix: $\mathbb{R}_{\text{0} \leq \text{x} \leq \text{1}}^{1 \times L}$ & - \\
\hline
\end{tabular}
\end{center}
...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
preprocessing & file : string & imageMatrix: $\mathbb{Z}^{w \times w}_{0 \le x \le 255}$ & - \\
\hline
\end{tabular}
\end{center}
