...
This repository has a [code of conduct](CodeOfConduct.md), I will
remove things that do not respect it.

### Acknowledgements

This CONTRIBUTING.md is based on the following [template](https://github.com/PurpleBooth/a-good-readme-template/blob/main/CONTRIBUTING.md).